<h2> 1612 357
1413. Minimum Value to Get Positive Step by Step Sum</h2><hr><div><p>Given an array of integers&nbsp;<code>nums</code>, you start with an initial <strong>positive</strong> value <em>startValue</em><em>.</em></p>
